                    ...
                    <div class="portlet-body form">
                        ...
                        <div id="div1"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control a" placeholder="" name="first_name" data-validation="required" data-validation-error-msg="This field is required">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label"> <?php echo lang('hrm_ln'); ?> <span class="requiredStar"> * </span></label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control b" placeholder="" name="last_name" data-validation="required" data-validation-error-msg="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label"> <?php echo lang('hrm_fathname'); ?> <span class="requiredStar"> * </span></label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control c" name="father_name"  placeholder=""  data-validation="required" data-validation-error-msg="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label"> <?php echo lang('hrm_mothname');?></label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control d" name="mother_name" placeholder="">
                                </div>
                            </div>
                             <div class="form-group">
                                <label class="control-label col-md-3"> <?php echo lang('hrm_daofbi'); ?> <span class="requiredStar"> * </span></label>
                                <div class="col-md-4">
                                    <input class="form-control date-picker e" name="birthdate"   type="text" >
                            ...
                            <div class="form-group last">
                                <label class="control-label"> <?php echo lang('hrm_empopho'); ?> </label>
                                <div class="">
                                        ...
                                        <div>
                                            <span class="btn default btn-file">
                                                ...
                                                <span class="fileinput-exists">
                                                    Change </span>
                                                <input type="file" name="userfile" class="f">
                                            </span>
                            ...
                            <div class="form-group" style="margin-right: 25%;">
                                <label class="col-md-4 control-label"> <?php echo lang('hrm_sex'); ?> <span class="requiredStar"> * </span></label>
                                <div class="col-md-6 marginLeftSex">
                                    <div class="radio-list">
                                        <label class="radio-inline">
                                            <input type="radio" name="sex" class="g" id="optionsRadios4" value="Male" data-validation="required" data-validation-error-msg=""> <?php echo lang('hrm_male'); ?> </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="sex" class="g" id="optionsRadios5" value="Female" data-validation="required" data-validation-error-msg=""> <?php echo lang('hrm_female'); ?> </label>
                                        </div>
                                </div>
                            </div> 
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea class="form-control h" name="present_address" rows="3"  data-validation="required" data-validation-error-msg=""></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label"> <?php echo lang('hrm_permant_add'); ?> <span class="requiredStar"> * </span></label>
                                <div class="col-md-6">
                                    <textarea class="form-control i" name="permanent_address" rows="3"  data-validation="required" data-validation-error-msg=""></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label"> <?php echo lang('hrm_phonum'); ?> <span class="requiredStar"> * </span></label>
                                <div class="col-md-1">
                                    <input type="text" class="form-control j" name="phoneCode" placeholder="+92"  data-validation="required" data-validation-error-msg="" value="<?php
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control k" name="phone" id="phone" placeholder="1600-000000"  data-validation="required" data-validation-error-msg="">
                            ...
                            <div class="col-md-offset-3 col-md-6"> 
                                <button type="button" id="btn_hidde" onclick="hidden_div()" class="btn btn-success btn-lg"> Next </button>
                            </div>
                            </div>
                        </div>             
                        <div style="display: none;" id="div2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" data-validation="required" data-validation-error-msg="" name="group" onchange="selectgroup(this.value)">
                                        <option value=""><?php echo lang('select'); ?></option>
                                    <?php
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> <?php echo lang('hrm_edu_qua'); ?></label>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input class="form-control eduForm date-picker" name="paYear_1" type="text" placeholder="YYYY" >
                                    <input class="form-control eduForm date-picker" name="paYear_2" type="text" placeholder="YYYY" >
                                    <input class="form-control eduForm date-picker" name="paYear_3" type="text" placeholder="YYYY" >
                                    <input class="form-control eduForm date-picker" name="paYear_4" type="text" placeholder="YYYY" >
                                    <input class="form-control eduForm date-picker" name="paYear_5" type="text" placeholder="YYYY" >
                                </div>
                            </div>
                          <!--  <div class="form-group last">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> User Status <span class="requiredStar"> * </span></label>
                                <div class="col-md-6">
                                    <select name="status" class="form-control" data-validation="required" data-validation-error-msg="Select User Status">
                                        <option value=""><?php echo lang('select'); ?></option>
                            ...
                            <div class="col-md-offset-3 col-md-6">
                                ...
                                <button type="button" class="btn btn-primary" id="pre_btn">Previous</button>
                            </div>
                            </div>
                        </div>
...
var toValidate = jQuery('.a, .b, .c, .d, .e, .f, .g, .h, .i, .j, .k'),
    valid = false;
