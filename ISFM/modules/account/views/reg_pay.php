            ...
            <div class="col-md-12" >
                ...
                <div class="portlet box green ">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open_multipart("users/reg_pay?id=$slip_id", $form_attributs);
                        ?>
                        <div class="form-body">
                            <?php
                            if (!empty($success)) {
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text" class="form-control" value="<?php echo $regfee;?>" name="total" readonly="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Payment Received <span class="requiredStar"> * </span></label>
                                <div class="col-md-5">
                                    <input type="text" class="form-control" value="<?php echo $regfee;?>" name="paid_amount" data-validation="required" data-validation-error-msg="Pleas enter your payment amount." readonly="">
                                </div>
                            </div>
                            <div class="form-group">
