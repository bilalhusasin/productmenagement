                        ...
                        ?>
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div id="section_div" >
                                            <input type="text" name="section" class="form-control classGroupInput" placeholder="blue,red,green,yellow,...etc" style="text-transform: uppercase;">
                                            <small>Add All Section in this class using 'RED,GREEN' to seprate the section</small>
                                        </div>
