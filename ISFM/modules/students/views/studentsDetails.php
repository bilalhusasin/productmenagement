                        ...
                        <?php
                            foreach ($studentInfo as $row) {
                               ...
                               // $phone = $row['phone'];
                                ...
                                $id = $data2['id'];
                                $stu_id = $data2['student_id'];
                                $class_id = $data2['class_id'];
                                $section = $data2['section'];
                                $nam = $data2['student_nam'];
                                $gender = $data2['gender'];
                                $dateOfBireth = $data2['birth_date'];
                                $fatherName = $data2['farther_name'];
                                $phone = $data2['phone'];
                                ...
                                $status = $data2['status'];
                                $status_reason = $data2['status_reason'];
                                ?>
                ...
                <div class="col-md-3">
                    <ul class="ver-inline-menu tabbable margin-bottom-10">
                        ...
                        <?php if($this->common->user_access('stud_edit_delete',$userId)){ ?>
                            <li> 
                                <a href="index.php/students/editStudent?id=<?php echo $id;?>&sid=<?php echo $stu_id;?>&class_id=<?php echo $class_id;?>&section=<?php echo $section;?>">
                ...
                <div class="col-md-9 stuInfoTableBG">
                    <div class="row">
                        <div class="col-md-12 profile-info">
                                ...
                                <h1 class="teacherTitleFont"><?php echo $nam ?></h1>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 col-xs-6 detailsEvent">
                                        Status Reason <span>: </span>
                                    </div>
                                    <div class="col-sm-6 col-xs-6 detailsEvent">
                                        <?php echo $status_reason; ?>
                                    </div>
                                </div>
                                <?php }?>
