    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    Full Class Result Class and Section Wise<small></small>
                </h3>
                    ...
                    <div id="tab_0" class="tab-pane active">
                        <div class="portlet box green">
                            <div class="portlet-title">
                                <div class="caption">
                                    Select Class And Section for Full Result
                                </div>
                                <div class="tools">
                            ...
                            <div class="portlet-body form">
                                ...
                                echo form_open('examination/selectClassSection', $form_attributs);
                                ?>
                                <div class="form-body">
...
<script>
    function classSection(str) {
        ...
        xmlhttp.open("GET", "index.php/examination/ajaxClsSection?q=" + str, true);
        xmlhttp.send();
    }
</script>
