    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    Combine Student Mark Sheet<?php //echo lang('header_stu_mark_shee'); ?> <small></small>
                </h3>
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                      Combine Student's Mark Sheet  <?php // echo lang('header_stu_mark_shee'); ?>
                    </li>                        
                    ...
                    <div id="tab_0" class="tab-pane active">
                        <div class="portlet box green">
                            <div class="portlet-title">
                                <div class="caption">
                                    Select Class And Student Name For Combine Mark Sheet <?php //echo lang('exa_scasfms'); ?>
                                </div>
                                <div class="tools">
                            ...
                            <div class="portlet-body form">
                                ...
                                echo form_open('examination/combineClassMarksheet', $form_attributs);
                                ?>
                                <div class="form-body">
...
<script>
    function classSection(str) {
        ...
        xmlhttp.open("GET", "index.php/examination/combineajaxClassMarkshit?q=" + str, true);
        xmlhttp.send();
    }
</script>
<script>
    function selectSection(str) {
        ...
        xmlhttp.open("GET", "index.php/examination/ajaxcombineselectSection?q=" + str, true);
        xmlhttp.send();
    }
</script>
<script>
