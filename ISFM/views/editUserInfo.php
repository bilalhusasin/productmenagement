                ...
                <div class="portlet box green ">
                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select onchange="checkstatus(this.value)" name="status" class="form-control">
                        ...
                        <!-- <div class="form-group">
                            <label class="col-md-3 control-label">User Status Reason</label>
                            <div class="col-md-6">
                                <textarea rows="2" name="status_reason" class="form-control"><?php echo $row1['status_reason']; ?></textarea>
                            </div>
                        </div> -->
...
function checkstatus(str) {
        ...
        xmlhttp.open("GET", "index.php/users/reason?q=" + str, true);
        xmlhttp.send();
    }
</script>