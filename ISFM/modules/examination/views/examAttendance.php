                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="created_by_<?php echo $i; ?>" value="<?php echo $userId; ?>" readonly="">
                                <input type="hidden" name="userId_<?php echo $i; ?>" value="<?php echo $row['user_id']; ?>" readonly="">
