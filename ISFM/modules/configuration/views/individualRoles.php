                ...
                <div class="portlet box green ">
                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select id="reseverGroup" onchange="selectReceiver(this.value)" class="form-control" name="receiverGroup" required>
                                        ...
                                        <option value="<?php echo $row['id']; ?>"><?php echo $row['name'];  echo $row['id']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3"><?php echo lang(''); ?>Employes</label>
                                <div class="col-md-4">
                                    <select id="ajaxResult_2" name="userId" onchange="getIndividualRole(this.value)" class="form-control input-xlarge select2me" placeholder="Select...">
