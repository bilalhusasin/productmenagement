            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    <div class="portlet-title noprint">
                        <div class="caption">
                            " <?php echo $examTitle; ?> " <?php echo lang('exa_rou_succ_1'); echo " Class";?> " <?php echo $class_title. " and Section Class " .$section; ?> "
                        </div>
                        <div class="tools">
                                ...
                                <div class="row">
                                    <div class="col-md-12 textAlignCenter"> 
                                        ...
                                        <p>
                                            ...
                                            Class Section : <?php echo $section; ?><br>
                                    ...
                                    <div class="portlet-body">
                                        <div class="table-responsive">
                                            ...
                                            <?php }
                                                 ...
                                                 echo"<b>This Class Exam Routine Not Completed! Subjects, Date and Time Not Added.<b>";
                                            }?>
                                        </div>
                                    </div>
                                </div>
