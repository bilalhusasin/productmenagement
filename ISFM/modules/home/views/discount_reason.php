...
"columns": [
    ...
    "buttons": [
            ...
            { extend: 'csvHtml5', title: 'Student Discount Report(TPS)',footer: true },
            { extend: 'pdfHtml5',  title: 'Student Discount Report(TPS)',footer: true }
        ],
        deferRender:    true,
          scrollY:        "300px",
        scrollX:        true,
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    <?php echo ('Student Fee Discount Report'); ?> <small></small>
                </h3>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat purple-plum">
                        ...
                        <div class="details">
                            <div class="number">
                                <?php echo $calculate_disc;?>
                            </div>
                            <div class="desc">
                                <?php echo ('Gross Discount'); ?>
                            </div>
                        </div>
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="portlet green box">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-bullhorn"></i><?php echo (' Discount Percentage'); ?>
                            </div>
                        </div>
            ...
            <?php if ($this->common->user_access('das_class_info', $userId)) { ?>
                <div class="col-md-12 col-sm-12">
                    <div class="portlet purple box">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-cogs"></i><?php echo ('Student Discount information'); ?>
                            </div>
                            <div class="tools">
...
var myDoughnutChart = new Chart(ctx, {
    ...
    data: {
    datasets: [{
       data: [ <?php echo $Active_stds; ?>,  <?php echo $Deactive_stds; ?>]
        ,
