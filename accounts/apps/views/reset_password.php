...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <form id="frmReset" action="auth/reset-password/<?php echo $code; ?>" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <button type="submit" name="submit" class="btn btn-primary btn-block btn-flat">Update Password</button>
                    </div>
                </div>
            </form>
