                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                <label class="col-md-4 control-label"> Select Group <span class="requiredStar"> * </span></label>
                                <div class="col-md-7">
                                    <select onchange="selectGroup(this.value)" class="form-control" name="groupId" data-validation="required" data-validation-error-msg="<?php echo lang('con_yhtsao'); ?>">
                                        <option value=""> <?php echo lang('select'); ?> </option>
                                        <?php
                                        foreach ($group_info as $rowg) { ?>
                                        <option value="<?php echo $rowg['id']; ?>"> <?php echo $rowg['name']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            <div id="ajaxResultgroupId"> </div>
                            <!-- <div class="form-group">
                            ...
                            <!-- <div class="form-group">
                                <label class="col-md-4 control-label"> dsds<?php echo lang('con_job_post'); ?> <span class="requiredStar"> * </span></label>
                                <div class="col-md-7">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php $group_id=$row1['group_id']; 
                                        $query=$this->db->query("SELECT name FROM groups WHERE id='$group_id'");
                                        $query->result_array();
                                    ...
                                    <td >
                                        <a class="btn btn-xs green" href="index.php/configuration/editEmploySalary?rId=<?php echo $row1['id']; ?>" title="Edit Salery Info"> <i class="fa fa-pencil"></i> <?php // echo lang('edit'); ?> </a>

                                        <a class="btn btn-xs red" href="index.php/configuration/setEmployDelete?rId=<?php echo $row1['id']; ?>&uId=<?php echo $row1['employ_user_id']; ?>" onClick="javascript:return confirm('<?php echo lang('con_con_dele_sala_sett'); ?>')" title="Delect Salary Info"> <i class="fa fa-trash-o"></i> <?php // echo lang('delete'); ?> </a>
                                    </td>
                                </tr>
                                <?php $i++;} ?>
                            </tbody>
...
var xmlhttp;
if (str.length === 0) {
document.getElementById("ajaxResultgroupId").innerHTML = "";
return;
}
...
document.getElementById("ajaxResultgroupId").innerHTML = xmlhttp.responseText;
}
};
xmlhttp.open("GET", "index.php/configuration/ajaxSelectGroup?gId=" + str, true);
xmlhttp.send();
}
