        ...
        <section class="invoice">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-center">Ledger Report</h3>
                    <h4 class="page-center"><?php if (isset($chart_name['name'])) { echo $chart_name['name']; } else { echo 'Full Ledger'; } ?></h4>
                </div>
                <!-- /.col -->
            </div>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="col-md-1">Journal No.</th>
                                <th class="col-md-4">Name of A/C</th>
