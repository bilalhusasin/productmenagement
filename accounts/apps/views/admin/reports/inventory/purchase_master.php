...
<section class="content">
    <div class="box box-primary">
        ...
        <form id="frmPurchase" action="report/purchase-report" method="post" target="_blank">
            <div class="box-body">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="supplier_id" id="supplier_id" class="form-control select2" data-placeholder="Supplier">
