...
class Configuration extends MX_Controller {
    ...
    public function setStuFee() {
        if ($this->input->post('submit', TRUE)) {
            ...
            $annual_fund=$this->input->post('annual_founds', TRUE);
            $tution_fee=$this->input->post('tution_fee', TRUE);
            $ac = $this->input->post('ac_charges', TRUE);
            ...
            $data = array(
                ...
                'annual_fund' => $this->db->escape_like_str($annual_fund),
                'tution_fee' => $this->db->escape_like_str($tution_fee),
                'ac_charges' => $this->db->escape_like_str($ac),
                'issue_date' => $this->db->escape_like_str($issue_date),
    ...
    // This function will set monthly class fee structure information
    public function get_data(){
        $class_id = $this->input->get('q');
        $query1=$this->db->query("SELECT session FROM class_fee_structure WHERE class_id='$class_id'");
        $data=$query1->result_array();
        echo'<div class="form-group">
                <label class="col-md-4 control-label">'."Session".'<span class="requiredStar"> * </span></label>
                <div class="col-md-8">
                    <select onchange="sessionId(this.value)" class="form-control" name="session" id="session" data-validation="required">
        ...
        $query1 = $this->db->query("SELECT * FROM fee_structure")->row();

        $query = $this->db->query("SELECT * FROM class_fee_structure WHERE class_id=$class_id")->row();
        //echo $query1;
        //$bad= "alert(</script>";
        echo json_encode(array_merge(array($query),array($query1)));*/
         
    }
    // This function will set monthly class fee structure information
    public function ajaxClassMonthFee(){
        $class_id = $_POST['class_id'];
        $session = $_POST['session'];
        $query = $this->db->query("SELECT * FROM fee_structure WHERE session= $session");
        $data=$query->result_array();
        if(!empty($data)){
            foreach($data as $row){
               $annual_fund=$row['annual_fund'];
            }
        }
        else{
             $annual_fund=0;
        }
        $query1 = $this->db->query("SELECT * FROM class_fee_structure WHERE class_id=$class_id AND session=$session");
        ...
        echo'
            <div class="form-group">
                ...
                <div class="col-md-8 ">
                    <input type="text" id="annual_founds" name="annual_founds" value="'.$annual_fund.'" placeholder="" class="form-control" readonly="">
                </div>
            </div>
            <div class="form-group">
            <label class="col-md-4 control-label "> Tution Fee </label>
                <div class="col-md-8 ">
                    <input type="text" name="tution_fee" id="tution_fee" value="'.$tution_fee.'" placeholder="" class="form-control" readonly="">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-4 control-label "> A/C Charges </label>
                <div class="col-md-8 ">
                    <input type="text" name="ac_charges" id="ac_charges" value="'.$ac_charges.'" placeholder="" class="form-control" >
                </div>
            </div> ';
    }
    ...
    public function fee_item_edit() {
        if ($this->input->post('submit', TRUE)) {
            ...
            $data = array( 
                ...
                'admission_fee'    => $this->db->escape_like_str($this->input->post('admission_fee', TRUE)),
                'annual_fund'   => $this->db->escape_like_str($this->input->post('annual_founds', TRUE)),
                'tution_fee'   => $this->db->escape_like_str($this->input->post('tution_fee', TRUE)),
                'ac_charges'   => $this->db->escape_like_str($this->input->post('ac_charges', TRUE)),
                'issue_date'   => $this->db->escape_like_str($this->input->post('issue_date', TRUE)),
    ...
    public function delete_fee_item() {
        ...
        if ($this->db->delete('fee_item', array('id' => $id)) && $this->db->delete('slip', array('class_id' => $class_id))) {
           // $data['classTile'] = $this->common->getAllData('class');
            $data['fee_item'] = $this->common->getAllData('fee_item');
            $data['message'] = '<div class="alert alert-success alert-dismissable">
								<button aria-hidden="true" data-dismiss="alert" class="close" type="button"></button>
    ...
    //This function is using for set fee's Structure and other fees
    public function fee_structure() {
        if ($this->input->post('submit', TRUE)) {
            $data = array(
                'user_id'     => $this->db->escape_like_str($this->input->post('userid', TRUE)), 
                'session'     => $this->db->escape_like_str($this->input->post('add_year', TRUE)),
                'month'     => $this->db->escape_like_str($this->input->post('add_month', TRUE)),
                'admission_fee' => $this->db->escape_like_str($this->input->post('admission_fee', TRUE)),
                'annual_fund'    => $this->db->escape_like_str($this->input->post('annual_fund', TRUE)),
                'registration_fee'     => $this->db->escape_like_str($this->input->post('reg_fee', TRUE)),  
            ); 
            if ($this->db->insert('fee_structure', $data)) {
                $data['classTile'] = $this->common->getAllData('class');
                //$data['fee_item']  = $this->common->getAllData('fee_item');
                $data['fee_structure'] = $this->common->getAllData('fee_structure');
                $data['class_fe_structure'] = $this->common->getAllData('class_fee_structure');
                $data['message']   = '<div class="alert alert-success alert-dismissable">
                                      <button aria-hidden="true" data-dismiss="alert" class="close" type="button"></button>
                                      <strong> Success! </strong> Item added successfully.</strong>
                                      </div>';
    ...
    //This function will update class fee structure fee item information
    public function update_class_fee_structure() {
        if ($this->input->post('submit', TRUE)) {
            $userid = $this->input->post('userid', TRUE);
            $id = $this->input->post('class', TRUE);
            $session_year=$this->input->post('session_year', TRUE);
            $class_id=$this->input->post('class', TRUE);
            $tution_fee=$this->input->post('tution_fee', TRUE);
            $ac_charges=$this->input->post('ac_charges', TRUE);
            $data = array( 
                'session' => $this->db->escape_like_str($this->input->post('session_year', TRUE)),
                'class_id' => $this->db->escape_like_str($this->input->post('class', TRUE)),
                'tution_fee' => $this->db->escape_like_str($this->input->post('tution_fee', TRUE)),
                'ac_charges' => $this->db->escape_like_str($this->input->post('ac_charges', TRUE)),
                'created_by' => $this->db->escape_like_str($this->input->post('userid', TRUE))            
            );
            // $this->db->where('class_id', $id);
            // $this->db->insert('class_fee_structure', $data);
            $recored = $this->db->query("SELECT * FROM class_fee_structure WHERE class_id=$class_id AND session=$session_year");
              $d=$recored->result_array();
        if(!empty($d)){
            if( $this->db->where('class_id', $id) && $this->db->where('session', $session_year)){
               $this->db->update('class_fee_structure', $data);
                $data['fee_structure'] = $this->common->getAllData('fee_structure');
                $data['classTile'] = $this->common->getAllData('class');
                $data['class_fe_structure'] = $this->common->getAllData('class_fee_structure');
                $data['message'] = '<div class="alert alert-success alert-dismissable">
                                <button aria-hidden="true" data-dismiss="alert" class="close" type="button"></button>
                                <strong> Success! </strong> Item information  successfully.</strong>
                            </div>';
                $this->load->view('temp/header');
                $this->load->view('fee_structure', $data);
                $this->load->view('temp/footer');
            ...
            if ($this->db->query("INSERT INTO class_fee_structure (session,class_id,tution_fee,ac_charges) VALUES ($session_year,$class_id,$tution_fee,$ac_charges) ON DUPLICATE KEY UPDATE session=$session_year,class_id=$class_id,tution_fee=$tution_fee,ac_charges=$ac_charges;")) {*/ 
                $data['fee_structure'] = $this->common->getAllData('fee_structure');
                $data['classTile'] = $this->common->getAllData('class');
                $data['class_fe_structure'] = $this->common->getAllData('class_fee_structure');
                $data['message'] = '<div class="alert alert-success alert-dismissable">
    ...
    // This function will update class fee structure information 
    public function update_class_structure(){
        $class_id = $_POST['class_id'];
        $session = $_POST['session']; 
        $query = $this->db->query("SELECT * FROM class_fee_structure WHERE class_id=$class_id AND session=$session")->row();
        echo json_encode($query);
    }
    //This function will edit fee structure fee item information
    public function edit_fee_structure() {
        if ($this->input->post('submit', TRUE)) {
            ...
            $this->db->where('id', $id);
            $this->db->where('session', $session);
            if ($this->db->update('fee_structure', $data)) { 
                $data['fee_structure'] = $this->common->getAllData('fee_structure'); 
                $data['classTile'] = $this->common->getAllData('class');
                $data['class_fe_structure'] = $this->common->getAllData('class_fee_structure');
                $data['message'] = '<div class="alert alert-success alert-dismissable">
            ...
            $id = $this->input->get('id'); 
            $data['fee_stru'] = $this->configarationmodel->edit_fee_stru($id);
            $this->load->view('temp/header');
            $this->load->view('edit_fee_structure', $data);
            $this->load->view('temp/footer');
        }
    }
   //This function will delete fee structure collection item
    public function delete_fee_structure() {
        $id = $this->input->get('id');
        if ($this->db->delete('fee_structure', array('id' => $id))) {
           // $data['classTile'] = $this->common->getAllData('class'); 
            $data['message'] = '<div class="alert alert-success alert-dismissable">
                                <button aria-hidden="true" data-dismiss="alert" class="close" type="button"></button>
                                <strong> Success! </strong> Item deleted from items list successfully.</strong>
    ...
    public function employSalary() {
        if ($this->input->post('submit', TRUE)) {
            ...
            $setData = array(
                'group_id' => $this->db->escape_like_str($this->input->post('groupId', TRUE)),
            ...
            if ($this->db->insert('set_salary', $setData)) {
               ...
               // $data['emplaye'] = $this->configarationmodel->employ();
                $data['group_info'] = $this->configarationmodel->group_info();
                $this->load->view('temp/header');
...
//This function will return salary persentise amount
    public function ajaxSelectGroup() {
        ...
        $dat=array();
        $queryuserinfo = $this->db->query("SELECT user_id FROM userinfo WHERE group_id='$group_id' AND status='Active'");
         $q=$queryuserinfo->result_array();
             foreach($q as$row)
             {
               $user_id=$row['user_id'];
                $query = $this->db->query("SELECT id,username FROM users WHERE user_status='Employee' AND salary=0 AND status='Active' AND id='$user_id'");
              $query1=$query->result_array(); 
              array_push($dat, $query1);
             }
        
        // $query = $this->db->query("SELECT id,username FROM users WHERE user_status='Employee' AND salary=0 AND status='Active' AND id='$user_id'");
        // $query1=$query->result_array(); 
       echo'<div class="form-group">
                <label class="col-md-4 control-label">'.lang("con_employee").'<span class="requiredStar"> * </span></label>
                <div class="col-md-7">
                    <select onchange="eployInfo(this.value)" class="form-control" name="emplyId" data-validation="required" data-validation-error-msg="'.lang("con_yhtsao").'">
                        <option value="">'. lang("select").'</option>';
                    foreach ($dat as $row) {
                     echo'<option value="'.$row[0]['id'].'"> '.$row[0]['username'].'</option>';
                                         } 
                    '</select>
                </div>
            </div>
    ...
    public function ajaxSelectUser() {
        ...
        if (!empty($group)) {
            ...
            $query = $this->db->query("SELECT user_id,full_name FROM userinfo WHERE group_id=$group");
            foreach ($query->result_array() as $row) {
                $data[] = $row;
            }
        ...
        /*if ($group == 1) {
            //If the student's groun was selected thene work here
            $query = $this->db->query("SELECT user_id,full_name FROM userinfo WHERE group_id=1");
            foreach ($query->result_array() as $row) {
                $data[] = $row;
            }
            echo '<option value="">' . lang('select') . '</option>';
            ...
            $query = $this->db->query("SELECT user_id,full_name FROM userinfo");
            foreach ($query->result_array() as $row) {
                $data[] = $row;
            }
            echo '<option value="">' . lang('select') . '</option>';
            ...
            //If the parent's groun was selected thene work here
            $query = $this->db->query("SELECT user_id,full_name FROM userinfo WHERE group_id=11");
            foreach ($query->result_array() as $row) {
                $data[] = $row;
            }
            echo '<option value="">' . lang('select') . '</option>';
    ...
    public function individualUser() {
        if ($this->input->post('submit', TRUE)) {
            ...
            $roleArray = array( 
                ...
                'add_group' => $this->db->escape_like_str($this->input->post('add_group', TRUE)),
                'group_list' => $this->db->escape_like_str($this->input->post('group_list', TRUE)),
                ...
                'gread_edit_dele' => $this->db->escape_like_str($this->input->post('gread_edit_dele', TRUE)), 
                ...
                'dateSheet' => $this->db->escape_like_str($this->input->post('dateSheet', TRUE)),
                'assets'=>$this->db->escape_like_str($this->input->post('assets', TRUE)),
                ...
                'combine_mark_sheet' => $this->db->escape_like_str($this->input->post('combine_mark_sheet', TRUE)),
                ...
                'student_reports' => $this->db->escape_like_str($this->input->post('student_reports', TRUE)),
                ...
                'add_event' => $this->db->escape_like_str($this->input->post('add_event', TRUE)),
                'calender' => $this->db->escape_like_str($this->input->post('calender', TRUE)), 
                ...
                'set_optional' => $this->db->escape_like_str($this->input->post('set_optional', TRUE)),
                'registration' => $this->db->escape_like_str($this->input->post('registration', TRUE)),
                'created_by' => $this->db->escape_like_str($this->input->post('created_by', TRUE)) 
            );
            ...
            if ($this->db->update('role_based_access', $roleArray)) {
                ...
                $data['message'] = '<div class="alert alert-success alert-dismissable text-capitalize">
                                        <button aria-hidden="true" data-dismiss="alert" class="close" type="button"></button>
                                        <strong>' . lang('success') . '</strong>' . "This user access updated Successfully." . '
                                </div>';
                $this->load->view('temp/header');
    ...
    public function groupRole() {
        if ($this->input->post('submit', TRUE)) {
            ...
            $roleArray = array(
                'group_id' => $this->db->escape_like_str($userGroupId),
                'das_top_info' => $this->db->escape_like_str($this->input->post('das_top_info', TRUE)),
                'das_grab_chart' => $this->db->escape_like_str($this->input->post('das_grab_chart', TRUE)),
                'das_class_info' => $this->db->escape_like_str($this->input->post('das_class_info', TRUE)),
                'das_message' => $this->db->escape_like_str($this->input->post('das_message', TRUE)),
            ...
            $query = $this->db->query("SELECT * FROM group_based_access WHERE group_id=$userGroupId");
            $qdata=$query->result_array(); 
            if(!empty($qdata)){
                $this->db->where('group_id', $userGroupId);         
                if ($this->db->update('group_based_access', $roleArray)) {
                      $this->db->where('group_id', $userGroupId);
                      $this->db->update('role_based_access', $roleArray);                                                    
                    $data['group'] = $this->configarationmodel->allGroup();
                    $data['message'] = '<div class="alert alert-success alert-dismissable text-capitalize">
                                            <button aria-hidden="true" data-dismiss="alert" class="close" type="button"></button>
                                            <strong>Success !</strong> This User Group\'s access Update perfectly.
                                    </div>';
                    $this->load->view('temp/header');
                ...
                if ($this->db->insert('group_based_access', $roleArray)) {
                    $data['group'] = $this->configarationmodel->allGroup();
                    $data['message'] = '<div class="alert alert-success alert-dismissable text-capitalize">
                                            <button aria-hidden="true" data-dismiss="alert" class="close" type="button"></button>
                                            <strong>Success !</strong> This user group\'s access Add perfectly.
                                    </div>';
                    $this->load->view('temp/header');
                    $this->load->view('groupRole', $data);
                    $this->load->view('temp/footer');
    ...
    if(!empty($data)){
        ...
        foreach ($data as $key => $val) {
            ...
            if ($key == 'add_group') {
                if ($val == 0) {
                    echo '<label class="roll_row"><input type="checkbox" name="add_group" value="1" > ' . " By this access user can add new Group into this software." . '</label>';
                } else {
                    echo '<label class="roll_row"><input type="checkbox" name="add_group" value="1"  checked> ' . " By this access user can add new Group into this software." . '</label>';
                }
            }
             // Role No 
            if ($key == 'group_list') {
                if ($val == 0) {
                    echo '<label class="roll_row"><input type="checkbox" name="group_list" value="1" > ' . " By this access user can check Group details information." . '</label>';
                } else {
                    echo '<label class="roll_row"><input type="checkbox" name="group_list" value="1" checked > ' . " By this access user can check Group details information." . '</label>';
                }
            }
            // Role No 20
            if ($key == 'add_new_class') {
            ...
            if ($key == 'class_promotion') {
                if ($val == 0) {
                    echo '<label class="roll_row"><input type="checkbox" name="class_promotion" value="1" > ' . " By this access user can class promotion into this software. " . '</label>';
                } else {
                    echo '<label class="roll_row"><input type="checkbox" name="class_promotion" value="1" checked> ' . " By this access user can class promotion into this software. " . '</label>';
                }
            }
            // Role No 24
            if ($key == 'class_promotion') {
            ...
            if ($key == 'assin_optio_sub') {
                if ($val == 0) {
                    echo '<label class="roll_row"><input type="checkbox" name="assin_optio_sub" value="1" > ' . " By this access user can assign optional subject into this software. " . '</label>';
                } else {
                    echo '<label class="roll_row"><input type="checkbox" name="assin_optio_sub" value="1" checked> ' . " By this access user can assign optional subject into this software. " . '</label>';
                }
            }
            ...
            // Role No 
            if ($key == 'gread_edit_dele') {
                if ($val == 0) {
                    echo '<label class="roll_row"><input type="checkbox" name="gread_edit_dele" value="1" > ' . " By this access user can edit & delete grade into this software." . '</label>';
                } else {
                    echo '<label class="roll_row"><input type="checkbox" name="gread_edit_dele" value="1" checked> ' . " By this access user can edit & delete grade into this software." . '</label>';
                }
            }
            // Role No 41
            if ($key == 'add_exam_routin') {
            ...
            if ($key == 'dateSheet') {
                if ($val == 0) {
                    echo '<label class="roll_row"><input type="checkbox" name="dateSheet" value="1" >  ' . " By this access user can View Date Sheet in this software. " . '</label>';
                } else {
                    echo '<label class="roll_row"><input type="checkbox" name="dateSheet" value="1" checked>  ' . " By this access user can View Date Sheet in this software. " . '</label>';
                }
            }
            // Role No 
            if ($key == 'assets') {
                if ($val == 0) {
                    echo '<label class="roll_row"><input type="checkbox" name="assets" value="1" >  ' . " By this access user can View assets in this software. " . '</label>';
                } else {
                    echo '<label class="roll_row"><input type="checkbox" name="assets" value="1" checked>  ' . " By this access user can View assets in this software. " . '</label>';
                }
            }
            // Role No 43
            if ($key == 'own_exam_routine') {
            ...
            // Role No 
            if ($key == 'combine_mark_sheet') {
                if ($val == 0) {
                    echo '<label class="roll_row"><input type="checkbox" name="combine_mark_sheet" value="1" > ' . " By this access user can View combine mark sheet in this software. " . '</label>';
                } else {
                    echo '<label class="roll_row"><input type="checkbox" name="combine_mark_sheet" value="1" checked> ' . " By this access user can View combine mark sheet in this software. " . '</label>';
                }
            }
            // Role No 48
            if ($key == 'own_mark_sheet') {
            ...
            // Role No 
            if ($key == 'student_reports') {
                if ($val == 0) {
                    echo '<label class="roll_row"><input type="checkbox" name="student_reports" value="1" > ' . " By this access user can View student reports in this software. " . '</label>';
                } else {
                    echo '<label class="roll_row"><input type="checkbox" name="student_reports" value="1" checked> ' . " By this access user can View student reports in this software. " . '</label>';
                }
            } 
            // Role No 65
            if ($key == 'add_transport') {
            ...
            if ($key == 'add_event') {
                if ($val == 0) {
                    echo '<label class="roll_row"><input type="checkbox" name="add_event" value="1" > ' . " By this access user can add New event Detail in this software. " . '</label>';
                } else {
                    echo '<label class="roll_row"><input type="checkbox" name="add_event" value="1" checked> ' . " By this access user can add New event Detail in this software. " . '</label>';
                }
            }
             // Role No 
            if ($key == 'calender') {
                if ($val == 0) {
                    echo '<label class="roll_row"><input type="checkbox" name="calender" value="1" > ' . " By this access user can View calendar in this software. " . '</label>';
                } else {
                    echo '<label class="roll_row"><input type="checkbox" name="calender" value="1" checked> ' . " By this access user can View calendar in this software. " . '</label>';
                }
            }
            // Role No 90
            if ($key == 'delete_inven_issu') {
            ...
            if ($key == 'set_optional') {
                if ($val == 0) {
                    echo '<label class="roll_row"><input type="checkbox" name="set_optional" value="1" >' . " By this access user can set Options in this software. " . '</label>';
                } else {
                    echo '<label class="roll_row"><input type="checkbox" name="set_optional" value="1" checked>' . " By this access user can set Options in this software. " . '</label>';
                }
            }
            // Role No 
            if ($key == 'registration') {
                if ($val == 0) {
                    echo '<label class="roll_row"><input type="checkbox" name="registration" value="1" >' . " By this access user can take student Registration in this software. " . '</label>';
                } else {
                    echo '<label class="roll_row"><input type="checkbox" name="registration" value="1" checked>' . " By this access user can take student Registration in this software. " . '</label>';
                }
            } 
        ...
        echo '</div></div></div><div class="clearfix"></div>'; 
          ...
          //System admin access here
            ...
            <label class="roll_row"><input type="checkbox" name="add_group" value="1" > ' . " By this access user can add new Group into this software." . '</label>
            <label class="roll_row"><input type="checkbox" name="group_list" value="1" > ' . " By this access user can check Group details information." . '</label>
            ...
            <label class="roll_row"><input type="checkbox" name="class_promotion" value="1" > ' . " By this access user can class promotion into this software. " . '</label>
            ...
            <label class="roll_row"><input type="checkbox" name="assin_optio_sub" value="1" > ' . " By this access user can assign optional subject into this software. " . '</label>
            ...
            <label class="roll_row"><input type="checkbox" name="gread_edit_dele" value="1" > ' . " By this access user can edit & delete grade into this software." . '</label>
            ...
            <label class="roll_row"><input type="checkbox" name="dateSheet" value="1" >  ' . " By this access user can View Date Sheet in this software. " . '</label>
            <label class="roll_row"><input type="checkbox" name="assets" value="1" >  ' . " By this access user can View assets in this software. " . '</label>
            ...
            <label class="roll_row"><input type="checkbox" name="combine_mark_sheet" value="1" > ' . " By this access user can View combine mark sheet in this software. " . '</label>
            ...
            <label class="roll_row"><input type="checkbox" name="student_reports" value="1" > ' . " By this access user can View student reports in this software. " . '</label>
            ...
            <label class="roll_row"><input type="checkbox" name="add_event" value="1" > ' . " By this access user can add New event Detail in this software. " . '</label>
            <label class="roll_row"><input type="checkbox" name="calender" value="1" > ' . " By this access user can View calendar in this software. " . '</label>
            ...
            <label class="roll_row"><input type="checkbox" name="set_optional" value="1" >' . " By this access user can set Options in this software. " . '</label>
            <label class="roll_row"><input type="checkbox" name="registration" value="1" >' . " By this access user can take student Registration in this software. " . '</label>
