                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-xs green" href="index.php/sclass/classDetails?c_id=<?php echo $row['id']; ?>" title="Class Detail"> <i class="fa fa-send-o"></i> <?php // echo lang('details'); ?> </a>

                                        <?php // if($this->common->user_access('class_delete',$userId)){ ?>
                                        <a class="btn btn-xs blue" href="index.php/sclass/editClass?c_id=<?php echo $row['id']; ?>" title="Class Info Edit"> <i class="fa fa-pencil"></i> </a>
                                        <?php // } ?>

                                        <?php if($this->common->user_access('class_delete',$userId)){ ?>
                                        <a class="btn btn-xs red" href="index.php/sclass/deleteClass?id=<?php echo $row['id']; ?>" onClick="javascript:return confirm('Are you sure you want to delete this Class ?')" title="Delete Class Detail"> <i class="fa fa-trash-o"></i> <?php // echo lang('delete'); ?> </a>
                                        <?php }?>
                                    </td>
                                </tr>
                                <?php } ?>
