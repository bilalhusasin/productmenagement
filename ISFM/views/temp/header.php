    ...
    <body class="page-header-fixed page-quick-sidebar-over-content page-header-fixed-mobile page-footer-fixed1">
        ...
        <div class="page-header navbar navbar-fixed-top" style="background-color: gray; !important;">
            ...
            <div class="page-header-inner">
                ...
                <div class="page-logo">
                    <a href="index.php">
                        <img src="assets/admin/layout/img/smlogo.png" alt="logo" width="80px"> <!--class="logo-default"--> 
                    </a>
                                        ...
                                        foreach ($unreadMassage as $urm) {
                                            ...
                                            <li>
                                                <a href="index.php/message/readMassage?id=<?php echo $urm['id']; ?>">
                                                    ...
                                                    <span class="subject">
                                                        <span class="from"> <?php echo $senderName; ?> </span>
                                                        <span class="time">
        ...
        $s = "start";$a = "active";$o = "open";$dashbord = "";$admission = "";$registration = "";$allStudent = "";$studentClassPromote = "";$student = "";$teachersInfromation = "";$teachers = "";$note = "";$addNote = "";$seclectClassNote = "";$addTeachers = "";$notice = "";$Parents = "";$selectParents = "";$makeParents = "";$class = "";$addClass = "";$allClass = "";$subject = "";$addSubject = "";$attendanse = "";$exam = "";$addExame = "";$addBook = "";$allBook = "";$addSubject = "";$addClassRoutine = "";$classRoutine = "";$Marksheet = "";$Combinemarksheet = "";$fullclassresult = "";$transport = "";$addTransport = "";$allTransport = "";$allSubject = "";$makingResilt = "";$account = "";$addAccount = "";$message = "";$sendMessage = "";$inbox = "";$sent = "";$configuration = "";$userAccess = "";$weeklyDay = "";$language = "";$attendansePreviw = "";$allExamRutine = "";$dateSheet = "";$viewAttendence = "";$open = "";$resultView = "";$studentDetailLedger = "";$advanceRecept = "";$allSlips = "";$previousPayments = "";$generalSettings = "";$profileview = "";$cleander = "";$addEvent = "";$calenderEvents = "";$suggestion = "";$makeSuggestion = "";$allSuggestion = "";$dormitory = "";$addDormitory = "";$addBedSeat = "";$selectMemberBed = "";$dormitoryReport = "";$messageSettings = "";$systemUsers = "";$addGroup = "";$addNewUsers = "";$allUserInafo = "";$studentAtten = "";$teacherAtten = "";$leave = "";$applicationForLeave = "";$allLeaveApplication = "";$accountSetting = "";$setStuFee = "";$add_fee_stru = "";$paymentmethod = ""; $addpaymentMethod = ""; $set_student_fee_dis = ""; $studentsInfo = "";$ownClassRoutin = "";$promotion = "";$set_optional = "";$addNotice = "";$group = "";$employee = "";$employatt = "";$stock = "";$vendors = "";$inv_cate = "";$inv_item = "";$sms = "";$eas = "";$sel_ow_ma = "";$assets = "";$patty = "";
        if ($cont == "home") {
            if ($view == "index") {
                $dashbord = $s . ' ' . $a;
            ...
            if ($view == "admission") {
                ...
                $student = $s . ' ' . $a;
                $registration = $a;
            } elseif ($view == "registerd_student") { 
                $student11 = $s . ' ' . $a; 
                $student = $s . ' ' . $a; 
                $reg_student = $a; 
            } elseif ($view == "pass_student") { 
                $student11 = $s . ' ' . $a; 
                $student = $s . ' ' . $a; 
                $pass_student = $a; 
            ...
            if ($view == "allStudent") {
                ...
                $student = $s . ' ' . $a;
                $allStudent = $a;
            } elseif ($view == "studentClassPromote") {
                $student11 = $s . ' ' . $a;
                $student = $s . ' ' . $a;
                $studentClassPromote = $a;
            ...
            if ($view == "examGread") {
                ...
                $Marksheet = $a;
                $open = $o;
            } elseif ($view == "combineClassMarksheet") {
                $academic = $s . ' ' . $a;
                $exam = $s . ' ' . $a;
                $combinemarksheet = $a;
                $open = $o;
            }elseif ($view == "selectClassSection") {
                $academic = $s . ' ' . $a;
                $exam = $s . ' ' . $a;
                $fullclassresult = $a;
                $open = $o;
            ...
            if ($view == "addAccountTitle" || $view == "deleteAccount" || $view == "editAccountInfo") {
                ...
                $account = $s . ' ' . $a;
                $teacherCollection = $a;
            } elseif ($view == "studentDetailLedger" ) {
                $account = $s . ' ' . $a;
                $studentDetailLedger = $a;
            } elseif ($view == "advanceRecept" || $view == "editAdvanceReceipt" || $view == "viewAdvanceReceipt" || $view == "delAdvanceReceipt") {
                $account = $s . ' ' . $a;
                $advanceRecept = $a;
            }elseif ($view == "allSlips" || $view == "view_invoice" || $view == "editSlip" || $view == "deletSlipItem" || $view == "deletSlip" || $view == "slipAction" || $view == "fee_pay" || $view == "student_vocher" ) {
                $account = $s . ' ' . $a;
                $allSlips = $a;
            } elseif ($view == "previousPayments") {
                $account = $s . ' ' . $a;
                $$previousPayments = $a;
            ...
            if ($view == "conWeeklyDay") {
                ...
                $accountSetting = $s . ' ' . $a;
                $employSalary = $a;
            } elseif ($view=="addpaymentMethod") { 
                $paymentmethod = $s . ' ' . $a;
                $addpaymentMethod = $a;
            } elseif ($view=="set_student_fee_dis") { 
                $paymentmethod = $s . ' ' . $a;
                $set_student_fee_dis = $a;
            }
                    ...
                    <ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
                                    ...
                                    <?php } if ($this->common->user_access('add_exam_gread', $userId) || $this->common->user_access('exam_gread', $userId) || $this->common->user_access('add_exam_routin', $userId) || $this->common->user_access('all_exam_routine', $userId) || $this->common->user_access('datesheet', $userId) || $this->common->user_access('take_exam_attend', $userId) || $this->common->user_access('exam_attend_preview', $userId) || $this->common->user_access('make_result', $userId) || $this->common->user_access('approve_result', $userId) || $this->common->user_access('view_result', $userId) || $this->common->user_access('all_mark_sheet', $userId) || $this->common->user_access('combine_mark_sheet', $userId) || $this->common->user_access('own_mark_sheet', $userId)) { ?>
                                        <li class="nav-item <?php echo $exam; ?>">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <?php //} 
                                                if ($this->common->user_access('add_exam_routin', $userId)) { ?>
                                            ...
                                            <?php } if ($this->common->user_access('dateSheet', $userId)) { ?>
                                                     <li class="nav-item <?php echo $dateSheet; ?>">
                                                        <a href="index.php/examination/dateSheet" class="nav-link ">
                                                            <span class="title"> <?php echo lang('header_all_exam_date'); ?></span>
                                                        </a>
                                                    </li>
                        ...
                        <?php } if ($this->common->user_access('admission', $userId) || $this->common->user_access('all_student_info', $userId) || $this->common->user_access('stu_own_info', $userId) || $this->common->user_access('take_studence_atten', $userId) || $this->common->user_access('attendance_preview', $userId) || $this->common->user_access('make_parents_id', $userId) || $this->common->user_access('all_parents_info', $userId)) { ?>
                            <li class="nav-item <?php echo $student11; ?>">
                                ...
                                <ul class="sub-menu">
                                    <?php if ($this->common->user_access('admission', $userId) || $this->common->user_access('registration', $userId) || $this->common->user_access('all_student_info', $userId) || $this->common->user_access('stu_own_info', $userId)) { ?>
                                        <li class="nav-item <?php echo $student; ?>">
                                            ...
                                            <ul class="sub-menu">
                                                <?php if ($this->common->user_access('registration', $userId)) { ?>
                                                    <li class="nav-item <?php echo $registration; ?>">
                                                        <a href="index.php/users/registration" class="nav-link ">
                                                            <span class="title">Registration</span>
                                                        </a>
                                                    </li>
                                                    <li class="nav-item <?php echo $reg_student; ?>"> 
                                                        <a href="index.php/users/reg_stu" class="nav-link "> 
                                                            <span class="title">Registerd Students</span> 
                                                        </a> 
                                                    </li>
                                                    <li class="nav-item <?php echo $pass_student; ?>"> 
                                                        <a href="index.php/users/pass_student" class="nav-link "> 
                                                            <span class="title">Pass Students</span> 
                                                        </a> 
                                                    </li> 
                        ...
                        <?php // }
                         if ($this->common->user_access('add_group', $userId) || $this->common->user_access('add_employee', $userId) || $this->common->user_access('employee_list', $userId) || $this->common->user_access('employ_attendance', $userId) || $this->common->user_access('empl_atte_view', $userId) || $this->common->user_access('check_leav_appli', $userId)) { ?>
                            <li class="nav-item <?php echo $hrm; ?>">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <?php if ($this->common->user_access('add_group', $userId) || $this->common->user_access('group_list', $userId)) { ?>
                                        <li class="nav-item <?php echo $group; ?>">
                                            <a href="javascript:;" class="nav-link nav-toggle">
                                                <span class="title"> User Groups</span>
                                                <span class="arrow"></span>
                                            </a>
                                            <ul class="sub-menu">
                                                <?php if ($this->common->user_access('add_group', $userId)) { ?>
                                                    <li class="nav-item <?php echo $addGroup; ?>">
                                                        <a href="index.php/users/addGroup" class="nav-link ">
                                                            <span class="title"> Add User Group</span>
                                                        </a>
                                                    </li>
                                                <?php // } if ($this->common->user_access('group_list', $userId)) { ?>
                            ...
                            <li class="nav-item <?php echo $account; ?>">
                                ...
                                <ul class="sub-menu">
                                    <?php if ($this->common->user_access('add_account_title', $userId)) { ?>
                                        ...
                                        <li class="nav-item <?php echo $assets; ?>">
                                            <a href="javascript:;" class="nav-link nav-toggle">
                                                <span class="title">Assets</span>
                                                <span class="arrow"></span>
                                            </a>
                                            <ul class="sub-menu">
                                            <li class="nav-item <?php echo $patty; ?>">
                                                <a href="index.php/account/patty_cash" class="nav-link ">
                                    ...
                                    <?php } if ($this->common->user_access('all_slips', $userId)) { ?>
                                        <li class="nav-item <?php echo $advanceRecept; ?>">
                                            <a href="index.php/account/advanceRecept" class="nav-link ">
                                                <span class="title">Advance Receipt</span>
                                            </a>
                                        </li>                                                               
                                        ...
                                        <li class="nav-item <?php echo $previousPayments; ?>">
                                            <a href="index.php/account/previousPayments" class="nav-link ">
                                                <span class="title"> Previous Payments</span>
                                            </a>
                                        </li>
                                        <li class="nav-item <?php echo $studentDetailLedger; ?>">
                                            <a href="index.php/account/studentDetailLedger" class="nav-link ">
                                                <span class="title">Student Wise Detail Ledger</span>
                                            </a>
                                        </li>
                        ...
                        <?php } if ($this->common->user_access('student_reports', $userId)){ ?>
                            <li class="nav-item <?php echo $studentReport; ?>">
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="fa fa-file"></i>
                                    <span class="title"><?php echo 'Student Reports'; ?></span>
                                    <span class="arrow"></span>
                                </a>
                                <ul class="sub-menu"> 
                                    <?php if ($this->common->user_access('student_reports', $userId)) { ?>
                                    ...
                                    <li class="nav-item <?php echo $Student_fee; ?>">
                                        <a href="index.php/home/Student_fee" class="nav-link ">
                                            <span class="title"><?php echo 'Student Fee'; ?></span>
                                        </a>
                                    </li> 
                                    <li class="nav-item <?php echo $discount_reason; ?>">
                                        <a href="index.php/home/discount_reason" class="nav-link ">
                                            <span class="title"><?php echo 'Fee Discounts'; ?></span>
                                        </a>
                                    </li> 
                                    ...
                                    <li class="nav-item <?php echo $FeeReceipt_reports; ?>">
                                        <a href="index.php/home/FeeReceipt_reports" class="nav-link ">
                                            <span class="title"><?php echo 'Fee Receipts'; ?></span>
                                        </a>
                                    </li> 
                        ...
                        <?php } if ($this->common->user_access('add_event', $userId) || $this->common->user_access('calender', $userId)) { ?>
                        <li class="nav-item <?php echo $cleander; ?>">
                            ...
                            <ul class="sub-menu">
                            <?php if ($this->common->user_access('add_event', $userId)) { ?>
                            ...
                            <?php } if ($this->common->user_access('calender', $userId)) { ?>
                        ...
                        <?php if ($this->common->user_access('setting_manage_user', $userId) || $this->common->user_access('setting_accounts', $userId) || $this->common->user_access('other_setting', $userId)) { ?>
                            <li class="nav-item <?php echo $configuration; ?>">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <?php } if ($this->common->user_access('setting_accounts', $userId)) { ?>
                                        <li class="nav-item <?php echo $accountSetting; ?>">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li class="nav-item <?php echo $add_fee_stru; ?>">
                                                    <a href="index.php/configuration/fee_structure" class="nav-link ">
                                                        <span class="title">Add Fee Structure</span>
                                                    </a>
                                                </li>
                                    ...
                                    <?php } ?>
                                        <li class="nav-item <?php echo $paymentmethod; ?>">
                                            <a href="javascript:;" class="nav-link nav-toggle">
                                                <span class="title"><?php  echo lang('set_payment_method'); ?></span>
                                                <span class="arrow"></span>
                                            </a>
                                            <ul class="sub-menu">
                                                <li class="nav-item <?php echo $addpaymentMethod; ?>">
                                                    <a href="index.php/account/addpaymentMethod" class="nav-link ">
                                                        <span class="title"><?php  echo lang('add_payment_method');?></span>
                                                    </a>
                                                </li> 
                                            </ul>
                                        </li>
                                        <li class="nav-item <?php echo $setdiscount; ?>">
                                            <a href="javascript:;" class="nav-link nav-toggle">
                                                <span class="title">Discount</span>
                                                <span class="arrow"></span>
                                            </a>
                                            <ul class="sub-menu">
                                                <li class="nav-item <?php echo $addfeediscount; ?>">
                                                    <a href="index.php/account/addfeediscount" class="nav-link ">
                                                        <span class="title">Add Fee Discount</span>
                                                    </a>
                                                </li> 
                                                <li class="nav-item <?php echo $set_student_fee_dis;  ?>">
                                                    <a href="index.php/account/set_student_discount" class="nav-link ">
                                                        <span class="title">Set student Fee Discount</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li> 
