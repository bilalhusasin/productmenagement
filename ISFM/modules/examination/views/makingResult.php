                ...
                <div class="portlet box green ">
                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Enter Total Marks <?php // echo lang('exa_teacher_name'); ?> <span class="requiredStar"> * </span></label>
                                <div class="col-md-6">
                                    <input class="form-control" type="text" name="total_marks" id="total_marks" onkeyup="go()">
                                            ...
                                            <thead>
                                                <tr>
                                                   ...
                                                   <!--  <th width="60px">
                                                    ...
                                                    <th width="60px">
                                                        Total Marks <?php  // echo lang('exa_ct_toma'); ?> 
                                                    </th>
                                                    <th width="60px">
                                                       Obtain marks <?php // echo lang('exa_ct_toma'); ?> <!-- Total Mark -->
                                                    </th>
                                                     <th width="60px">
                                                       Remarks <?php // echo lang('exa_ct_toma'); ?> <!-- Total Mark -->
                                                    </th> 
                                                </tr>
                                            </thead>
                                            <tbody> 
                                                ...
                                                foreach ($students as $row) {
                                                    ...
                                                    <tr>
                                                       ...
                                                       <!--  <td>
                                                        ...
                                                        <td>
                                                            <input class="form-control" type="text" name="totalMark_<?php echo $i; ?>" id="tmark<?php echo $i; ?>" placeholder=" total mark <?php // echo lang('exa_ct_toma'); ?>"  data-validation="required" data-validation-error-msg="" readonly="">
                                                        </td>
                                                        <td>
                                                            <input class="form-control" type="text" name="obtainMark_<?php echo $i; ?>" placeholder="Obtain Mark <?php // echo lang('exa_ct_toma'); ?>"  data-validation="required" data-validation-error-msg="">
                                                        </td>
                                                        <td>
                                                             <!-- <input class="form-control" type="text" name="remark_<?php // echo $i; ?>" placeholder=" Remarks <?php // echo lang('exa_ct_toma'); ?>"  data-validation="required" data-validation-error-msg=""> -->
                                                             <select class="form-control " name="remark_<?php echo $i; ?>"  data-validation="required" data-validation-error-msg="">
                                                                <option value=""> Select.... </option>
                                                                <option value="Pass"> remark 1 <?php // echo lang('exa_pass'); ?> </option>
                                                                <option value="Fail"> remark 2  <?php // echo lang('exa_fail'); ?> </option>
                                                                <option value="Absent"> remark 3  <?php // echo lang('exa_absent'); ?> </option>
                                                            </select>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
  ...
  function go()
{
   ...
   // alert (i);
  for(var j=1; j<= i; j++ ){
    document.getElementById("tmark"+j).value = marks;
}
}
</script>
