              ...
              <div class="col-md-6"> 
                <a href="javascript:history.back()"> 
                  <button type="button" class="btn btn-default no-print">
                    <i class="fa fa-mail-reply-all"></i> <?php echo lang('back'); ?> 
                  </button>
                </a>
              </div>
            </div>
            <div class="col-md-12">
                ...
                <div class="portlet box green ">
                    <div class="portlet-title no-print">
                        <div class="caption "> Student Fee Voucher
                    ...
                    <div class="portlet-body">  
                      <div class="row mr-t-neg">
                            ...
                            <?php 
                            //voucher is multi indexing array
                            // print_r($voucher); 

                                $student_id = $voucher[0]['student_id'];
                                $class_id = $voucher[0]['class_id'];
                                $month = $voucher[0]['month'];
                                $issue_date = $voucher[0]['issue_date'];
                                $due_date = $voucher[0]['due_date'];
                                $annual_fee = $voucher[0]['annual_fee'];
                                $tution_fee = $voucher[0]['tution_fee'];
                                $ac_charges = $voucher[0]['ac_charges'];
                                $total = $voucher[0]['total'];
                                $dis_total = $voucher[0]['dis_total'];
                                $discount = $voucher[0]['discount'];
                                $student_voucher = $voucher[0]['voucher_number'];
                                $revise_loan = $voucher[0]['revise_loan'];
                                
                                // second array
                              if(!empty($voucher[1])){
                                $dues = $voucher[1]['dues'];
                                $balance = $voucher[1]['balance'];
                              } else{
                                $dues = 0;
                                $balance = 0;
                              }
                            ?>
                        <div class="col-md-4 table_print"  style="font-size: x-small;">
                          <div style="border: 1px solid #000;"> 
                            ...
                            <p align="center" style="font-size:10px; font-weight:800;">Monthly Fee Voucher</p>
                            <div style="border-top: 1px solid #000;border-bottom: 1px solid #000;">
                             <table class="table " style="text-transform: uppercase; ">  
                                <tr>
                                    <td style="width: 31%;">student name:</td>
                                    <th colspan="3" style="text-align: left;"> <?php echo $this->common->student_title($student_id);?> </th>
                            ...
                            <div>
                             <table class="table" style="text-transform: uppercase;" >
                                ...
                                <tr>
                                    <td><?php echo $i++; ?></td>
                                    <td>A/C Charges</td>
                                    <td><?php echo $ac_charges;?> </td>
                                    <td> - </td>
                                </tr> 
                                <tr> 
                                    <th colspan="2" style="text-align: center;"> Gross amount</th> 
                                ...
                                <tr> 
                                    <td colspan="2" align="center"> Revise Fee Loan</td> 
                                    <td> <?php echo $revise_loan; ?> </td>
                                    <td> </td>
                                </tr>
                                <!-- <tr> 
                                    <td colspan="2" align="center"> Previous Balance</td> 
                                    <td> <?php echo $balance; ?> </td>
                                    <td> </td>
                                </tr> -->
                                <tr> 
                                    <td colspan="2" align="center"> Previous Dues</td> 
                                    <td> <?php echo $dues; ?> </td>
                                    <td> </td>
                                </tr> 
                                <tr>
                                    <td> </td>
                                    <td colspan="2" > After Discount/Loan</td> 
                                    <td> <?php echo $dis_total; ?> </td>
                                </tr>
                                <tr>
                                    <td> </td>
                                    <th colspan="2"> Payable</th> 
                                    <th> <?php echo $dis_total; ?> </th>
                                </tr>
                             </table>
                            </div>
                            ...
                            <div  style="border-top: 1px solid #000;" >
                              <table class="table" id="table_l">
                                 <tr>
                                   <td colspan="2" style="font-weight: 800; text-transform: uppercase;" id="tdfont"> Term & conditions for school dues</td> 
                                 </tr>
                                 <tr>
                                   <td>1</td>
                                 ...
                                 <tr>
                                   <td>5</td>
                                   <td >Re-Admission will br granted after paying Rs. 2,000/- asre-admission fee.</td> 
                                 </tr>
                                 <tr>
                                   <td>6</td>
                                   <td style="font-size: 10px;">Re-Admission con not be claimed after 10 days of name being struck off.</td> 
                                 </tr>
                                 <tr>
                                   <td>7</td>
...
$(function() {
    $(document).ready(per);
    function per() {
        var totalamount = "<?php echo $dis_total; ?>";
