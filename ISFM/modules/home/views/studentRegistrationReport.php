    ...
    <div class="page-content">
        ...
        <div class="row no-print">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    <?php echo ('Students Registration Report'); ?> <small></small>
                </h3>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="portlet purple box">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-search"></i><?php echo 'Search Students Registration Report'; ?>
                        </div>
                        <div class="tools">
            ...
            <?php if ($this->common->user_access('das_class_info', $userId)) { ?>
                <div class="col-md-12 col-sm-12">
                    <div class="portlet purple box">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-cogs"></i><?php echo ('Students Registration Report'); ?>
                            </div>
                            <div class="tools">
