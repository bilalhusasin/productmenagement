            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open('sclass/editClass', $form_attributs);
                        ?>
                        <div class="form-body">
                            <?php foreach($class as $row){
                             $classTitle = $row['class_title'];
                             $section = $row['section'];
                             $class_student_capacity = $row['section_student_capacity'];
                             $classcode = $row['classCode'];
                            }?>
                            <?php $c_id= $class_id;?>
                            <input type="hidden" name="class_id" value="<?php echo $c_id;?>" readonly="readonly">
                            <div class="form-group">
                                <label class="col-md-3 control-label"> <?php echo lang('clas_class_title'); ?> <span class="requiredStar"> * </span></label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control text-uppercase" name="class_title" value="<?php echo $classTitle;?>" data-validation="required" data-validation-error-msg="<?php echo lang('clas_cls_tit_requi'); ?>" style="text-transform: uppercase;">
                                </div>
                            </div>
                            <!-- <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div id="section_div">
                                        <input type="text" name="section" class="form-control classGroupInput text-uppercase" value="<?php echo $section;?>">
                                        <small>Add Section in this class using 'RED,GREEN' to seprate the section</small>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6"> 
                                    ...
                                    <select name="capicity" class="form-control"  data-validation="required" data-validation-error-msg="Select section's student capacity.">
                                        <option value="<?php echo $class_student_capacity;?>"><?php echo $class_student_capacity; ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="class_code" onkeyup="classSection(this.value)" class="form-control" value="<?php echo $classcode; ?>"  data-validation="required" data-validation-error-msg="<?php echo lang('clas_code_requir'); ?>" readonly>
                        ...
                        <div class="form-actions fluid">
                            <div class="col-md-offset-3 col-md-6">
                                <button type="submit" name="submit" class="btn green" value="Add Class"><?php echo lang('clas_up_button'); ?></button>
