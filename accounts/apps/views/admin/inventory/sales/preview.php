...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"> Sales Preview</li>
    </ol>
</section>
...
<section class="invoice">
    ...
    <div class="row">
        <div class="col-md-12">
            <h2 class="page-header">
                ...
                <small class="pull-right">Date: <?php echo date_to_ui($master[0]['sales_date']); ?></small>
            </h2>
            <h3 class="page-center">Sales Invoice</h3>
        </div>
        <!-- /.col -->
    </div>
    ...
    <div class="row invoice-info">
        <div class="col-md-6 invoice-col">
            <strong>Sales #</strong> <?php echo $master[0]['sales_no']; ?><br>
            <strong>Date:</strong> <?php echo date_to_ui($master[0]['sales_date']); ?><br>
    ...
    <div class="row no-print">
        <div class="col-md-12">
            <a href="inventory/sales-print/<?php echo $master[0]['sales_no']; ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
