                ...
                <div class="portlet box green">
                    ...
                    <div class="portlet-body form leaveApplicationForm" style="font-size: 18px">
                        ...
                        <div class="form-body">
                            ...
                            <div  style="width: 115px; float: left; height: 37px;"><input class="form-control date-picker " id="mask_date1" type="text" name="startDate" placeholder="dd-mm-yyyy" data-validation="required date" data-validation-format="dd-mm-yyyy" data-validation-error-message="<?php echo lang('app_gtlsd'); ?>"></div>
                            <div  style="min-width: 50px; float: left; padding-left: 10px; padding-right: 10px; height: 37px;"> <?php echo lang('app_until'); ?></div>
                            <div  style="width: 117px; float: left;height: 37px;"><input class="form-control date-picker" id="mask_date2" type="text" name="endDate" placeholder="dd-mm-yyyy" data-validation="required date" data-validation-format="dd-mm-yyyy" data-validation-error-message="<?php echo lang('app_gtled'); ?>"></div>.
