                            ...
                            <tbody>
                                ...
                                foreach ($notice as $row) {
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <a href="index.php/notice/noticeDetails?notes_id=<?php echo $row['id']; ?>" title="View Notes <?php echo $row['subject']; ?>"> <?php echo $row['subject']; ?> </a>
                                        </td>
                                        <td>
                                            <div id="ellipsis">
                                                    <?php echo $row['notice']; ?>
                                        ...
                                        <td>
                                            <?php if ($this->ion_auth->is_admin()) { ?>
                                                <a class="btn btn-xs red" onClick="javascript:return confirm('Are you sure you want to delete this notice?')" href="index.php/notice/deleteNotice?notes_id=<?php echo $row['id']; ?>"> <i class="fa fa-trash-o"></i> <?php echo lang('delete'); ?> </a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                    <?php
