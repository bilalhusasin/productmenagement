        ...
        <div class="row no-print">
            <div class="col-md-12">
                ...
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                       Student fee Voucher <?php // echo lang('header_stu_payme'); ?>
                    </li>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green ">
                    <div class="portlet-title no-print">
                        <div class="caption "> Student Admission / Annual Fee Voucher
                  ...
                  <?php // print_r($voucher); 
                    foreach ($voucher as $row) {
                        ...
                        $student_nam=$row['student_nam'];
                        $reg_number=$row['reg_number'];
                        $reg_date=$row['reg_date'];
                        $due_date=$row['due_date'];
                        $admission_fee=$row['admission_fee'];
                        $admission_disc=$row['admission_disc'];
                        $annual_found=$row['annual_found'];
                        $tution_fee=$row['tution_fee'];
                        $tution_disc=$row['tution_disc'];
                        $ac_charges=$row['ac_charges'];
                        $actual_total=$row['actual_tot'];
                        $dis_total=$row['disc_tot'];
                        $total=$row['total'];
                        $session=$row['session'];
                        ...
                        <div class="col-md-4 table_print" style="font-size: x-small;">
                          <div style="border: 1px solid #000;"> 
                            ...
                            <p align="center" style="font-size:10px; font-weight:800;">Admission Fee Voucher</p>
                            <div style="border-top: 1px solid #000;border-bottom: 1px solid #000;">
                             <table class="table " style="text-transform: uppercase; ">  
                                <tr>
                                    <td>student name</td>
                                    <th> <?php echo $student_nam;?> </th>
                                    <td colspan="2"></td> 
                                </tr> 
                             </table>
                             <table class="table " style="text-transform: uppercase; "> 
                            ...
                            <div>
                             <table class="table" style="text-transform: uppercase; " >
                                ...
                                <tr>
                                    ...
                                    <td> <?php echo $admission_disc; ?> </td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>Annual Funds</td>
                                    <td><?php echo $annual_found; ?></td>
                                    <td> 0 </td>
                                </tr>
                                <tr>
                                    <td>2</td>
                            ...
                            <div  style="border-top: 1px solid #000;font-size: xx-small !important;" >
