...
"columns": [
     ...
     "buttons": [
            ...
            { extend: 'csvHtml5', title: 'Student Fee Report(TPS)',footer: true },
            { extend: 'pdfHtml5',  title: 'Student Fee Report(TPS)',footer: true }
        ],
        deferRender:    true,
          scrollY:        "300px",
        scrollX:        true,
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    <?php echo ('Student Fee Structure Report'); ?> <small></small>
                </h3>
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="portlet green box">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-bullhorn"></i><?php echo ('Monhtly Collections Trend'); ?>
                            </div>
                        </div>
            ...
            <?php if ($this->common->user_access('das_class_info', $userId)) { ?>
                <div class="col-md-12 col-sm-12">
                    <div class="portlet purple box">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-cogs"></i><?php echo ('Student Dues information'); ?>
                            </div>
                            <!-- <div class="tools">
...
foreach ($date_wise_students as $cap) {
    if($cap['class_title']!="")
   { echo "'" . $cap['class_title'] . "',";}
}
?>
              ],
    datasets: [{
      label: "Class wise receivings",
