            ...
            <div class="col-md-12">
                <div class="portlet box green">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open("examination/editGrade?id=$id", $form_attributs);
                        ?>
                        ...
                        <div class="form-actions fluid">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <button type="button" class="btn default" onclick="location.href = 'javascript:history.back()'">Back</button>
                            </div>
                        </div>
                        <?php echo form_close(); ?>
                        <!-- END FORM-->
