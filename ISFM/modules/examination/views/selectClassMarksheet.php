                    ...
                    <div id="tab_0" class="tab-pane active">
                        <div class="portlet box green">
                            ...
                            <div class="portlet-body form">
                                ...
                                echo form_open('examination/selectClassMarksheet', $form_attributs);
                                ?>
                                <div class="form-body">
...
<script>
    function classSection(str) {
        ...
        xmlhttp.open("GET", "index.php/examination/ajaxClassMarkshit?q=" + str, true);
        xmlhttp.send();
    }
</script>
<script>
    function selectSection(str) {
        ...
        xmlhttp.open("GET", "index.php/examination/ajaxselectsection?q=" + str, true);
        xmlhttp.send();
    }
</script>
<script>
