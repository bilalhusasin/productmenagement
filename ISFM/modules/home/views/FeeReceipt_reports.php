    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    <?php echo ('Fee Receipt Report'); ?> <small></small>
                </h3>
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="portlet green box">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-bullhorn"></i><?php echo ('Monthly Fee Received & Expected Fee trend'); ?>
                            </div>
                        </div>
            ...
            <?php if ($this->common->user_access('das_class_info', $userId)) { ?>
                <div class="col-md-12 col-sm-12">
                    <div class="portlet purple box">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-cogs"></i><?php echo ('Student Fee Receipts information'); ?>
                            </div>
                            <div class="tools">
...
var config = {
  ...
  data: {
    labels: [
<?php
foreach ($total_discount1 as $cap) {
...
?>
      ...
      data: [
        <?php
foreach ($total_discount2 as $cap) {
