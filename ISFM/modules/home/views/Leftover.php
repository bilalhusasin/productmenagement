...
{  
 ...
 // Setup - add a text input to each footer cell
    $('#datatable tfoot th').each( function () {
        var title = $(this).text();
        //console.log("Leftover Student Report(TPS)");
...
"columns": [
            ...
            { data: "class_title" },
            { data: "section" },
            { data: "dis_total",className: "total" },
            { data: "date_of_leaving" },
            { data: "left_over_reason" }
    ...
    "buttons": [
            ...
            { extend: 'csvHtml5', title: 'Leftover Student Report(TPS)',footer: true },
            { extend: 'pdfHtml5',  title: 'Leftover Student Report(TPS)',footer: true }
        ],
        deferRender:    true,
          scrollY:        "300px",
        scrollX:        true,
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="portlet green box">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-bullhorn"></i><?php echo ('LeftOver Students'); ?>
                            </div>
                        </div>
                    ...
                    <div class="portlet purple box">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <?php echo ('LeftOver Student information'); ?>
                            </div>
                            <div class="tools">
